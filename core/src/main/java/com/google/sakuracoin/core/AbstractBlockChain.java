 ...
 * the lightweight SPV mode, a {@link com.google.sakuracoin.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link com.google.sakuracoin.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
...
if (params.getId().equals(NetworkParameters.ID_TESTNET)) { // TODO
    ...
    private void checkTestnetDifficulty(StoredBlock storedPrev, Block prev, Block next) throws VerificationException, BlockStoreException {
        ...
        // There is an integer underflow bug in sakuracoin-qt that means mindiff blocks are accepted when time
        // goes backwards.
    ...
    private boolean verifyTarget(Block block , BigInteger newDifficulty) throws VerificationException {
