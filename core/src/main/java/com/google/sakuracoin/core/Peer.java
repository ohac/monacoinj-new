 ...
 * {@link com.google.sakuracoin.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.google.sakuracoin.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
    ...
    private static class GetDataRequest {
        ...
        // a nasty hack that relies on the fact that sakuracoin-qt is single threaded and processes messages in order.
     ...
     * {@link com.google.sakuracoin.net.NioClientManager#openConnection(java.net.SocketAddress, com.google.sakuracoin.net.StreamParser)}
     * or
     * {@link com.google.sakuracoin.net.NioClient#NioClient(java.net.SocketAddress, com.google.sakuracoin.net.StreamParser, int)}.</p>
     *
     ...
     * Once the pong is received the value returned by {@link com.google.sakuracoin.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.sakuracoin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.sakuracoin.core.Peer#ping()} has never
